...
@section('content')
    ...
    <div class="container-xxl py-2 border fw-bolder" style="height: auto;text-align:right;direction: rtl"> 
        ...
        / 
        <a class="text-dark">  نقل إلى {{$sub_institution->institution_name}} </a> 
    </div> 
    <!-- root page End -->
    ...
    <div class="container-xxl pt-5 pb-3" style="min-height: calc(100vh - 95px);direction: rtl">
        <div class="container">
            <form  data-toggle="validator" role="form" method="post" action="{{route('store_devices_to_sub_institution',$sub_institution->institution_slug)}}">
                @csrf
