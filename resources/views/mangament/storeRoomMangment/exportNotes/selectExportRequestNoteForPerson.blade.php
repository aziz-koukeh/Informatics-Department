...
@section('content')
    ...
    <div class="container-xxl py-2 border fw-bolder" style="height: auto;text-align:right;direction: rtl"> 
        ...
        /
        <a class="text-dark">مذكرة تسليم إلى عهدة {{$employee->employee_full_name}}</a> 
    </div> 
    <!-- root page End -->
    ...
    <div class="container-xxl pt-5 pb-3" style="min-height: calc(100vh - 95px);direction: rtl">
        <div class="container">
            <form  data-toggle="validator" role="form" method="post" action="{{route('storeExportRequestNote',$employee->institution->institution_slug)}}" enctype="multipart/form-data">
                @csrf
                <div class="row justify-content-center">
                        ...
                        <div class="position-relative text-center mb-1 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <p>عهدة شخصية لـ <a href="{{route('showEmployee',$employee->employee_slug)}}">{{$employee->employee_full_name}}</a>  </p>
                                    <p> تابع لـ {{$employee->institution->institution_name}} </p>
                                    <div class="form-floating form-group">
                                        <input style="border: unset" type="text" class="form-control @error('export_request_note_by_person') is-invalid @enderror text-center" name="export_request_note_by_person" value="{{$employee->employee_full_name}}" id="export_request_note_by_person"  placeholder="export_request_note_by_person" readonly  >
                    ...
                    <div class="row justify-content-center g-2 mb-4">
                        ...
                        {{-- @forelse ($devices as $allowed_device) --}}
                        ...
                        {{-- @empty
                            <div class="col-lg-12 col-md-6 wow fadeInUp" data-wow-delay="0.07s">
                                <div class="card text-center shadow rounded overflow-hidden">
                                    <div class="rounded-circle overflow-hidden m-4">
                                        <img class="img-fluid" src="{{asset('assets/img/undraw_progressive_app_m-9-ms.svg')}}" alt="">
                                    </div>
